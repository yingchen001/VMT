...
if __name__ == '__main__':
    ...
    parser.add_argument('-train_src', default="vatex_data/train.clean.en", type=str, help='Path to training source data')
    parser.add_argument('-train_tgt', default="vatex_data/train.clean.zh", type=str, help='Path to training target data')
    parser.add_argument('-dev_src', default="vatex_data/valid.clean.en", type=str, help='Path to devation source data')
    parser.add_argument('-dev_tgt', default="vatex_data/valid.clean.zh", type=str, help='Path to devation target data')
    ...
    parser.add_argument('-save_data', default='vatex_len_40', type=str, help='Output file for the prepared data')

    opt = parser.parse_args()
    print(opt)
    main(opt)

# python preprocess.py -train_src "data/train.de" -train_tgt "data/train.en" -dev_src "data/newstest2015.de" -dev_tgt "data/newstest2015.en" -save_data de-en-2015-test.pkl
