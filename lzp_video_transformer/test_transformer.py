...
if __name__ == "__main__":
    ...
    checkpoint_file = './checkpoints/transformer_new_3layer/epoch8_acc_54.52_ppl_9.51.pt'
    ...
    corpbleu, sentbleu = test_nltk(model, test_loader, tok_src, tok_tgt, max_steps=500, print_every=20)
