...
DATA_DIR = 'dataset/wmt17'
TRAIN_DATA_DIR = '{}/train'.format(DATA_DIR)
TRAIN_DATA_ZH_DIR = '{}/train.zh'.format(DATA_DIR)
TRAIN_DATA_EN_DIR = '{}/train.en'.format(DATA_DIR)
VALID_DATA_DIR = '{}/valid'.format(DATA_DIR)
VALID_DATA_ZH_DIR = '{}/valid.zh'.format(DATA_DIR)
VALID_DATA_EN_DIR = '{}/valid.en'.format(DATA_DIR)
TEST_DATA_DIR = '{}/test'.format(DATA_DIR)
TEST_DATA_ZH_DIR = '{}/test.zh'.format(DATA_DIR)
TEST_DATA_EN_DIR = '{}/test.en'.format(DATA_DIR)
